...
namespace DaihonConverter
{
    public class LineData
    {
        ...
        public bool ErrorFlg;       // キャラクター名エラーフラグ
        public bool PrintFlg;       // 印刷区切りフラグ
